...
describe('DefimistRouter', () => {
  ...
  beforeEach(async function() {
    ...
    factory = fixture.defimistFactory
  ...
  it('getAmountOut', async () => {
    ...
    ).to.be.revertedWith('DefimistLibrary: INSUFFICIENT_INPUT_AMOUNT')
    await expect(
      router.getAmountOut(bigNumberify(2), bigNumberify(0), bigNumberify(100), bigNumberify(30))
    ).to.be.revertedWith('DefimistLibrary: INSUFFICIENT_LIQUIDITY')
    await expect(
  ...
  it('getAmountIn', async () => {
    ...
    ).to.be.revertedWith('DefimistLibrary: INSUFFICIENT_OUTPUT_AMOUNT')
    await expect(
...
describe('fee-on-transfer tokens', () => {
  ...
  beforeEach(async function() {
    ...
    await fixture.defimistFactory.createPair(DTT.address, WETH.address)
    const pairAddress = await fixture.defimistFactory.getPair(DTT.address, WETH.address)
    pair = new Contract(pairAddress, JSON.stringify(IDefimistPair.abi), provider).connect(wallet)
  })
...
describe('fee-on-transfer tokens: reloaded', () => {
  ...
  beforeEach(async function() {
    ...
    // make a DTT<>WETH pair
    await fixture.defimistFactory.createPair(DTT.address, DTT2.address)
    const pairAddress = await fixture.defimistFactory.getPair(DTT.address, DTT2.address)
  })
