...
contract ExampleSwapToPrice {
    ...
    IDefimistRouter public immutable router;
    address public immutable factory;

    constructor(address factory_, IDefimistRouter router_) public {
        factory = factory_;
        router = router_;
    }
    ...
    function swapToPrice(
        ...
        uint256 amountIn;
        {
            (uint256 reserveA, uint256 reserveB) = DefimistLibrary.getReserves(factory, tokenA, tokenB);
            uint256 swapFee = DefimistLibrary.getSwapFee(factory, tokenA, tokenB);
